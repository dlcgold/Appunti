...
lo stato 0 e lo stato 2 l'etichettatura $\square\neg s$. Bisognerebbe rivedere
il progetto per garantire migliore equità.\\
\textbf{Ulteriori esempi nella lezione 8 di esercitazioni}\\
...
% LocalWords:  presets reverse rd dim ds ciclare shaking accettatore prefix
% LocalWords:  Peterson context
