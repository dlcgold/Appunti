...
\begin{figure}
  ...
  \label{fig:hyd2}
\end{figure}
\textit{Si ricorda che ogni atomo di carbonio forma 4 legami con altri atomi,
...
Ad esempio con le \textbf{finite state machine (\textit{FSM})} abbiamo una
rappresentazione di come l'evoluzione del sistema possa passare attraverso vari
stati. Con le \textbf{reti di Petri} abbiamo una versione succinta delle FSM con
delle eventuali estensioni. Si usano specialmente reti di Petri che sono
codifiche che dal punto di vista teorico sono più espressive delle FSM, in
quanto si riconosce un insieme di linguaggi che contiene quello riconosciuto
dalle FSM.\\
Si ha poi una particolare implementazione di FSM o di reti di Petri, detta
...
un tempo esterno, rappresentabile a sua volta da una FSM o da una serie di
...
\begin{enumerate}
  ...
  asimmetrica a seconda della presenza di un certo microambiente in cui si trova
  la cellula: 
  \begin{figure}[H]
    \centering
...
% LocalWords:  REST ligandi discretizzato Petri
