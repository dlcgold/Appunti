...
\textit{CNA}.
\section{Pipeline}
Possiamo quindi descrivere la \textbf{pipeline} per l'analisi di dati
...
\begin{enumerate}
  ...
  (\textit{di cui si è già discusso in realtà nella sezione precedente})
...
% LocalWords:  REST ligandi discretizzato Petri FSA primis delay propensità bin
% LocalWords:  Gillespie condition silico morfogeni discretizzare pathway query
...
% LocalWords:  etichettamento PiCnic sottomodulo deconvoluzione timepoint
% LocalWords:  sottovarianti sublineage encoding deconding autoencoder mapping
% LocalWords:  breakpoint sovradispersione centroidi doublet doublets
