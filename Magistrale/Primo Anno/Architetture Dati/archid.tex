...
\begin{itemize}
  ...
  alternative:
  \begin{enumerate}
    \item \textbf{remote recovery}, ovverol'RM chiede al TM cosa è accaduto
...
\begin{itemize}
  ...
  riscrivo quindi sull'architettura target. Da un \textit{publisher} si passa ad un
  \textit{distributor} e infine ai \textit{subscriber}
  % MANCA PARTE DB2
\end{itemize}
...
% LocalWords:  transactional merge over loss disaster mission critical load
% LocalWords:  kilometri consolidation distribution balancing offline entry
...
% LocalWords:  publish publisher distributor subscriber
