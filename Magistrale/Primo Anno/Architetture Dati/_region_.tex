...
si aggregano i 
risultati e si genera il file di output. Tra map e reduce su ha una fase su . Il framework si occupa di tutto il
resto, il developer si occupa solo della componente funzionale (\textbf{esempi
  su slide}).\\
...
\message{ !name(archid.tex) !offset(-5939) }
