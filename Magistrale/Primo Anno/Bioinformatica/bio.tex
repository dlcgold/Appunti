...
\textbf{Persa parte al minuto circa 40}.\\
La \textbf{distanza di edit} è un caso particolare dell'allineamento.\\
Il problema \textbf{LCS}, dove date due sequenze $A$ e $B$ si cerca la lunghezza
...
\[s_{i,j}=\max\
  ...
  \end{cases}
\]
Trovare il cammino ottimo della griglia corrisponde all'allineamento tra
sequenze. 
% inseriee pd
...
\end{document}  
% LocalWords:  clock burst bioinformatico bioinformatici aplotipi VCF NP Brujin
