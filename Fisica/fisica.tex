...
\end{cases}$$
%aggiungi lezione del 10 ottobre
\subsection{Esercizi}
prodotto scalare:
...
$$v_{med2}=\frac{5.2}{0.57+0.18}=4.4km/h$$
...
%aggiungo formula velocità finale
\end{esercizio}
\begin{esercizio}
...
1,9s
\end{cases}$$
sappiamo che per il volo completo impiega 1,2s, quindi impiegherà 0,53s per arrivare a 5m e 1,9s per salire all'apice e scendere nuovamente a 5m
\end{esercizio}
\begin{esercizio}
...
$$\downarrow$$
$$tan(\frac{\pi}{2}-theta)=\frac{\Delta x}{\Delta y}=\frac{1869}{1200}$$
$$\downarrow$$
$$\frac{\pi}{2}-\theta=arctan(\frac{1869}{1200})=57^{\circ}$$
\end{esercizio}
\section{Dinamica}
