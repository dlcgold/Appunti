...
\begin{definizione}
  ...
  \begin{itemize}
    ...
    di $B$
    \item $\pi(A\implies B)$ è una funzione  (o un funzionale, ovvero un
    ...
    \item $\pi(\neg A)$ è una costruzione $\pi'$ di $A\implies\bot$
  \end{itemize}
...
\[\frac{\stackrel{\stackrel{[A]}{\cdots}}{B}}{A\implies B}i\implies\]
Per l'eliminazione ho che, tramite \textbf{modus ponens}:
\[\frac{A\implies B\,\,\,\,A}{B}e\implies\]
