...
\begin{definizione}
  ...
  difficile alterare il contenuto di un blocco, ovvero diverse transazioni
  %6.57
\end{definizione}
\begin{figure}
  \centering
  ...
  \caption{Esempio di schema di blockchain. In verde a sinistra troviamo il
    \textbf{genesis block}. In nero i blocchi che formano la catena}
  \label{fig:bc}
\end{figure}
\end{document}
