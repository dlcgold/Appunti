...
\begin{definizione}
  Si definisce la funzione $C(k)$, che potremmo chiamare ``\textbf{average
    clustering distribution}'', come la media dei \textit{coefficienti di
...
% LocalWords:  rewiring trascrizionali regolatorie degree distribution
% LocalWords:  multipartiti