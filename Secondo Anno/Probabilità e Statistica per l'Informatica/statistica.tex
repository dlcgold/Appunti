...
\[Coc[X,Y]=E[(X-E[X])\cdot(Y-e[X])]=\int_{\mathbb{R}^2}\int (t-E[X])\cdot (s-E[Y])\cdot f_{X,Y}(t,s)\,dt\,ds\]
\[=\int_{\mathbb{R}^2}\int t \cdot s\cdot f_{x,y}(t,s)\,dt\,ds-\int_{\mathbb{R}}t\cdot f_X(t)dt\cdot \int_{\mathbb{R}}s\cdot f_Y(s)dt\]
