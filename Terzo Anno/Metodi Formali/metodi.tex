...
\begin{definizione}
  ...
  \begin{itemize}
    ...
    \[\underline{I}\cdot \underline{N}=0\]
...
\begin{esempio}
  ...
  una marca in $b$ conta (pesa) quanto due marche in $a$ o due marche in $c$. 
\end{esempio}
Bisogna quindi dare una definizione formale per questa situazione.
\begin{definizione}
