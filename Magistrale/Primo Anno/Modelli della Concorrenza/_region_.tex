\message{ !name(modelli.tex)}\documentclass[a4paper,12pt, oneside]{book}
...
\message{ !name(modelli.tex) !offset(-3) }
...
\textit{stati} e uno stato è per definizione un insieme di \textit{proprietà}
\end{document}
...
\message{ !name(modelli.tex) !offset(-7534) }
