\message{ !name(computazione.tex)}\documentclass[a4paper,12pt, oneside]{book}
...
\message{ !name(computazione.tex) !offset(-3) }
...
\begin{definizione}
  ...
  \textbf{TM deterministica} e che si potrà sviluppare una .
\end{definizione}
...
\message{ !name(computazione.tex) !offset(-1539) }
