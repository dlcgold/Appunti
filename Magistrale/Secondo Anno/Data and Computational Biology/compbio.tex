...
\textit{In base a quanto detto Elowitz and Leibler scelsero sperimentalmente
  ...
  il Repressilator.}  \\
L'obiettivo di ogni sforzo di modellazione (che mira a modellare, alla fine, i
pathway), infine, è osservare comportamenti plausibili con l'obiettivo di poter
prevedere quelli imprevisti. 
\end{document}
