...
\begin{enumerate}
  ...
  indipendenza dell'applicazione da modifiche dello schema
  logico. Un'applicazione 
...
\textbf{\textit{Le varie sigle precedute da \emph{in} si riferiscono ai paper
    che trattano l'argomento, tali paper sono indicati poi sulle slide}}\\
