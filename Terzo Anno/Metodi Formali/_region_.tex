...
\begin{teorema}
  ...
  Si ha che se $\Sigma=(N,M_0)$ è vivo allora $\forall R\subseteq S$, con $R$ 
\end{teorema}
...
% LocalWords:  Springer LNCS and learning Systems Transition Algebraic Colom
% LocalWords:  Teruel wait raw load dispoibile dep deposit empty object with
% LocalWords:  witdrawal upload unload withdrawal choice accettatori ssi tsi
% LocalWords:  bigboss dell sif sfi

\message{ !name(metodi.tex) !offset(-5064) }
