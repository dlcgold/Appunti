...
\begin{itemize}
  \item Variabili Proposizionali, proposizioni atomiche o proposizioni
  elementari: $P,Q,R,p_i, \dots$ 
...
\begin{enumerate}
  ...
  \simplies B)$, $(A \siff B)$, $TA$ e $FA$ sono delle formule ben formate.
...
\begin{esempio}
  ...
  \end{itemize}
\end{esempio}
\textbf{In una formula ben formato le parentesi sono bilanciate.}
