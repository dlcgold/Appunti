...
allo stato attuale, nessuno, nemmeno Dikov e altri, ci è arrivato quindi
...
\begin{table}[H]
  ...
  \end{tabular}
\end{table}
A cui si aggiunge anche, per praticità uso solo l'insieme minimale degli
operatori: 
\begin{table}[H]
  \Large
  \centering
...
% LocalWords:  backtracking Fitting Miglioli vedisi modalizzata Lewis
% LocalWords:  modalizzare Demodalizzare modalizzate demodalizzare
% LocalWords:  necessitazione necessitazioni
