...
Si parla del \textbf{teorema di incompletezza di G\"{o}del}. Come punto di partenza
...
\begin{definizione}
  ...
  che è iniettiva.\\
  Il numero, detto \textbf{numero di G\"{o}del} sarà sempre diverso da quello di una
...
% LocalWords:  autoriferimento iniettiva G\"{o}del Bernardinello
