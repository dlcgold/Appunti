...
% LocalWords:  Gitlab compatible PosgreSQL backuppati droppato Azure ER
% LocalWords:  intensionale processamento colonnare denormalizzare

\message{ !name(archid.tex) !offset(-4075) }
