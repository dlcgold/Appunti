...
lettura delle reads. Vediamo un esempio avendo:
...
\end{enumerate}
\subsection{SBH}
\textbf{SBH (\textit{Sequencing By Hybridation})} è una tecnologia che
analizza gli oligonucleotidi (di circa 6-10 basi). Per ogni k-mero
(chip), con $k \sim 8$, si conosce se appare nel genoma.
\end{document}
