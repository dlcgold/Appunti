...
\begin{definizione}
  ...
  \begin{itemize}
    ...
    \begin{figure}[H]
      ...
      \caption{Esempio di sistema 2-bounded (ma non 1-bounded}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \caption{Esempio di sistema non bounded, si andrà in \emph{overflow}}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \caption{Esempio di sistema safe (ovvero 1-bounded)}
    \end{figure}
  \end{itemize}
\end{definizione}
...
\begin{itemize}
  \item $RG(\Sigma)$ è finito
  \item $CG(\Sigma)$ è finito
\end{itemize}
Inoltre un sistema 
\end{document}
...
% LocalWords:  concorrentemente self abbastnza safe simil ptc Mayr bounded
% LocalWords:  overflow

\message{ !name(metodi.tex) !offset(-1841) }
