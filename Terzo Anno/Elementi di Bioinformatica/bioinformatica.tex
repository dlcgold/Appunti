...
\begin{itemize}
  ...
  \begin{center}
    ...
    U[c]=0010\\
  \end{center}
  \item ragiono sul word sixe $\omega$
\end{itemize}
ottengo:
\begin{center}
...
avere l'1 in posizione più significativa e ottengo i match, in pratica
la matrice non la stiamo costruendo, è solo un concetto teorico.\\
Però si ha il limite dei 64bit di lunghezza del pattern e l'uso di più
word comporta il riporto sulla colonna seguente, fattore che si
complica all'aumentare della lunghezza del pattern, soprattutto se
arbitraria. Abbiamo il vantaggio che non abbiamo if/else. 
\end{document}