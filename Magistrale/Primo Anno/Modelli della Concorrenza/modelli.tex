...
\[p^{\prime}=p_{\left[a \leftarrowa_{1} \cdot a_{2}\right]}=a_{1} \cdot a_{2}
  \cdot N i l \mid b . N i l \]
\[      q^{\prime}=q_{\left[a \leftarrow-a_{1}, a_{2}\right]}=a_{1} \cdot a_{2}
...
% LocalWords:  rietichettato interleaving
