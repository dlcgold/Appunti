...
Il caso più tipico in meritò alle unità dove fare deployment è il mondo del
...
\end{itemize}
Il deployment ``stile cloud'' non è comunque l'unico possibile e un esempio
quotidiano è il deployment di app mobile sui vari store, dove il back-end
probabilmente sarò gestito come sopra spiegato, mentre l'app in sé viene
...
progetto in Java):
\begin{itemize}
  \item code: Git, Svn, Jira, Ecplipse
...
% LocalWords:  compatibility backward Deployable units virtual machine shell
