...
\begin{esempio}
  ...
  $\overline{coin}$ (non posso sapere dove va e se vado sul nodo del tea si
  aspetta un'altra moneta, mentre magari si voleva il caffè). Quindi anche se le
  tracce sono le stesse ma non posso sostituire senza problemi le due
  macchinette, in qaunto se sostituisco $M_1$ con $M_2$ rischio di andare in
  deadlock.
...
% LocalWords:  rinominazione true LocalWords
