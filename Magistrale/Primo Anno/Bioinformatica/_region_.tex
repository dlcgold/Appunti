...
\section{Qualità dei Dati di Sequenziamento}
Valutiamo quindi la qualità del dato di sequenziamento e il formato standard
\textbf{FASTQ}, il formato di output dei sequenziatori di nuova generazione. \\
...
read. Per ogni base di una read NGS si ha quindi un \textit{indice di qualità},
detto 
\end{document}  
...
% LocalWords:  superstringa sottostringa Euleriano scafholding

\message{ !name(bio.tex) !offset(-1755) }
