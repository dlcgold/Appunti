...
\textbf{aggiungere intro da live per la doppia divisione}.\\
\textbf{aggiungere ultima parte live}\\
...
\begin{esempio}
  ...
  \begin{minted}{sql}
    Create View S1 (Name,Age) a
    sSelect GProf.Name as S1.Name, GProf.Age as S1.Age
    From GProf
  \end{minted}
   \begin{minted}{sql}
    Create View S2 (Name,Age) a
    sSelect GProf.Name as S2.Name, GProf.Age as S2.Age
    From GProf
  \end{minted}
    Con la seguente query per sapere i nomi dei professori che hanno più di 50
  anni:
