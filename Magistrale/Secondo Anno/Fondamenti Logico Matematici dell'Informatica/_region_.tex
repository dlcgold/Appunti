\message{ !name(fondmat.tex)}\documentclass[a4paper,12pt, oneside]{book}
...
\message{ !name(fondmat.tex) !offset(-3) }
...
\begin{itemize}
  \item $\square A$, ovvero \textit{necessario A}
  \item $\lozenge A$, ovvero \textit{possibile A}
\end{itemize}
...
logiche modali \textit{basate} sulla 
\end{document}
...
% LocalWords:  backtracking Fitting Miglioli vedisi modalizzata

\message{ !name(fondmat.tex) !offset(-3072) }
