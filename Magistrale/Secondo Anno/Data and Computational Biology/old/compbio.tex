...
\begin{figure}[H]
  ...
  \caption{Grafici relativi al modello del Repressilator ottenuti tramite
    ...
    tempo di traduzione. Le scale dei tre grafici sono indicative. I parametri sono
    specificati nel notebook di Mathematica presente nella pagina Moodle.}   
\end{figure}
\end{document}

% LocalWords:  clock  traslazionale pathway Repressilator nucleoide plasmide
% LocalWords:  cooperatività
