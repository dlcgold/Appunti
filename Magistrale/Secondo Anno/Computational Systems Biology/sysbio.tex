...
\end{definizione}
\begin{definizione}
  In un grafo si definisce \textbf{percorso} come una sequenza finita o infinita
  di archi che unisce una sequenza di vertici. Se il vertice di partenza
  coincide con quello di fine si parla di \textbf{ciclo}.
\end{definizione}
\begin{definizione}
...
% LocalWords:  rewiring trascrizionali regolatorie