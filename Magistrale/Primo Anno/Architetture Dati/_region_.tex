...
\end{esercizio}
\chapter{Blockchains}
\textit{Questa lezione è stata tenuta dal prof. Leporati}.\\
\textbf{Verificare bene quanto scritto in quanto mi sono perso ad un certo punto
  sulla distinzione o meno di nodi e blocchi e ho scritto assumendo che siano
  identici}.
\begin{definizione}
...
il \textit{double-spending} è quella di usare una \textit{trust detour part}
(\textbf{non ho capito se ha detto questo}), ovvero tipicamente una banca che
...
% LocalWords:  reporting warehousing commerce social testing compliant many
% LocalWords:  source directional resolution detention Tier staging event apply
% LocalWords:  publish publisher distributor subscriber intra inter paradigm
% LocalWords:  relational mismatch Blockchain mapper Delete framework group
...
% LocalWords:  spending bitcoins wallet

\message{ !name(archid.tex) !offset(-2207) }
