...
\begin{definizione}
  ...
  aggiunto un insieme di nod'in input, di cardinalità $N$ (generalmente
...
quindi un limite $T$ d'iterazioni entro le 
...
\end{itemize}
\subsubsection{definizione di convergenza del percettrone}
\textbf{Per completezza vengono aggiunte le note finali sul definizione presenti
  nelle slide}.
\begin{definizione}
  Se l'insieme degli input estesi è partito in due classi linearmente separabili
...
vettore d'input $\langle( x_1, \ldots x_n), t\rangle$, con $t$ output
corrispondente.\\
