...
A causa della termodinamica possiamo inoltre considerare \textbf{reazioni
  bidirezionali}:
\begin{center}
  \includegraphics[scale = 0.4]{img/equ.jpg}
\end{center}
...
\begin{center}
  \includegraphics[scale = 0.4]{img/equ2.jpg}
  \qquad
  \includegraphics[scale = 0.4]{img/equ3.jpg}
\end{center}
Dove:
\begin{itemize}
...
Studiamo meglio $K_M$, che è detta \textbf{costante di Michaelis-Menten}
%slide 65
