...
Un primo concetto è quello di espriremere un evento che deve avvenire un numero
infinito di volte, non necessariamente di seguito. Si parla di
\textit{fairness}.\\
...
\begin{esempio}
  ...
  iniziale. 
\end{esempio}
Un secondo concetto è quello di espriremere un evento che prima o poi diventa
vero e, una volta diventato tale, resta vero per sempre, ovvero, data una
proprietà $A$, si ha che:
\[\mathbf{FG}\,A\]
