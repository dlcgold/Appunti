...
\[R_1\oplus R_2\oplus\cdots R_n\implies P_1\oplus P_2\oplus\cdots P_m\]
...
della legge. \\
Possiamo riscrivere il formalismo della legge in modo da rimuovere $\implies$ e
...
state effettivamente ``unite'' in $C$.
...
Riprendiamo la formula $A+B\stackrel{k}{\implies}C$, e la sua versione
...
Consideriamo quindi la concentrazione totale dell'enzima e la chiamiamo $[E]_0$
...
velocità, ottenedo l'\textbf{equazione di Hill}, che in questo caso è:
