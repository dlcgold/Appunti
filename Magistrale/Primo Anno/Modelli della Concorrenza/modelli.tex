...
\begin{definizione}
  ...
  \begin{itemize}
    ...
    ovvero non ho cicli
    \item $\forall\,e\in E:\{x\in B\cup E|xF^*e\}$ è finito
    \item la relazione di conflitto $\#$ non è riflessiva, avendo:
    \[\#\subset X\times X\]
    definita come:
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=2cm,bend angle=45,auto]
    ...
    ;
  \end{tikzpicture}
  \caption{Esempio di rete di occorrenze}
\end{figure}
\begin{figure}[H]
  \centering
  \begin{tikzpicture}[node distance=2cm,bend angle=45,auto]
    ...
    ;
  \end{tikzpicture}
  \caption{Esempio di rete  che non è una rete di occorrenze, avendo $z\#z$,
    che quindi è una relazione riflessiva}
\end{figure}
\begin{definizione}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \phi(e_1)=\phi(e_2))\implies e_1=e_2$
      \item $\forall e\in E:\phi(\,^\bullet e)=\,^\bullet
      \phi(e)\land\phi(e^\bullet)=\phi(e)^\bullet$ quindi le precondizioni di un
      evento nella rete causale devono corrispondere alle pre dell'evento nel
      sistema elementare (e così anche per le post)
      \item $\phi(Min(N))=c_{in}$
    \end{itemize}
  \end{itemize}
\end{definizione}
\begin{esempio}
  Riprendendo il solito esempio di mutua esclusione si ha il seguente processo
  ramificato:
  \begin{figure}[H]
    \centering
    \includegraphics[scale = 0.6]{img/ram.jpg} 
  \end{figure}
\end{esempio}
\begin{definizione}
  ...
  Si ha che $\Pi_1$ è un \textbf{prefisso} di $\Pi_2$ sse:
  \begin{itemize}
...
\begin{esempio}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale = 0.6]{img/unf.jpg} 
  \end{figure}
\end{esempio}
