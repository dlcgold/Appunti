...
### Compilation
This repository doesn't offer PDF file because it is an **OPEN SOURCE** project! If you want notes you will compile text file and you will help with pull requests! It is **free** only for the people helps in this project!  
```shellscript
