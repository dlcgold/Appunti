...
\end{teorema}
\section{Hidden Markov Chain}
Le catene di Markov sono un modello importante e molto utilizzato.\\
Un altro modello essenziale è quello \textbf{hidden Markov models}, dove non si
possono osservare gli stati.\\
...
\begin{itemize}
  ...
  \item l'ipotesi di Markov del primo ordine
\end{itemize}
Si uniscono quindi reti bayesiane che evolvono nel tempo e processo Markoviano. 
\end{document}  
